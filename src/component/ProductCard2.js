      ...
      >
        <Link className="product-card position-relative">
          ...
          <div className="product-image">
            <img src="https://m.media-amazon.com/images/I/713Nb6CHS-L._AC_SX466_.jpg"  className="img-fluid ms-5 w-50" alt="product" />
            <img src="https://m.media-amazon.com/images/I/71QCWOP4YmS._AC_SX466_.jpg"  className="img-fluid ms-5 w-50" alt="product" />
          </div>
          <div className="product-details">
            <h6 className="brand">MusiBaby</h6>
            <h5 className="product-title">
            Bluetooth Speakers,MusiBaby Speaker,Outdoor, Portable,Waterproof,Wireless Speaker,Dual Pairing, Bluetooth 5.0,Loud Stereo,Booming Bass,1500. </h5>
            <StarRatings
              rating={3}
              name="rating"
              numberOfStars={5}
